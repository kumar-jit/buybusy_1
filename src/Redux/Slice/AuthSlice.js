...
export const handleSignUp = createAsyncThunk("auth/handleSignUp", async (arg, thankAPI) => {
    ...
    try {
        ...
        let auth = await createUserWithEmailAndPassword(authInstance, email, password);
...
export const handleSignIn = createAsyncThunk("auth/handleSignIn", async (arg, thankAPI) => {
...
export const {setInitialState, setIsloggedIn, setLoggedUserInfo, handleLogout} = AuthSlice.actions;
