...
const mapDispatchToProps = (dispatch) => ({
    fetchUserCartAndOrders: (userId) => dispatch(fetchUserCartAndOrders(userId))
});
export const OrderHistoryComponent = connect(mapStateToProps, mapDispatchToProps)(OrderHistoryComponentE);